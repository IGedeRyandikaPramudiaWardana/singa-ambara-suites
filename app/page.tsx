...
import BookingBar from "@/components/BookingBar"; // Import komponen BookingBar
...
export default function Home() {
  return (
    <main className="bg-[#0F1619]">
      ...
      {/* ================= HERO SECTION ================= */}
      {/* Tambahkan 'pb-20' agar ada ruang untuk Booking Bar di bawah */}
      ...
      {/* ================= BOOKING BAR (BARU) ================= */}
      {/* Ini akan muncul mengambang di perbatasan Hero dan About */}
      <BookingBar />


      {/* ================= ABOUT SECTION ================= */}
      {/* Tambahkan 'pt-20' agar tidak tertutup Booking Bar */}
      <section id="about" className="py-20 pt-24 px-4 md:px-10 max-w-7xl mx-auto border-b border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl group">
            <Image 
              src="https://images.unsplash.com/photo-1590490360182-f33efe29a795?q=80&w=2074&auto=format&fit=crop" 
              alt="Kamar Tidur Mewah" fill className="object-cover group-hover:scale-110 transition duration-700"
            />
          </div>
          {/* Foto Kanan: Balcony View */}
          <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl group">
            <Image 
              src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2070&auto=format&fit=crop" 
              alt="Pemandangan Balkon" fill className="object-cover group-hover:scale-110 transition duration-700"
            />
          </div>
        </div>

        <div className="text-center mb-8">
          <h2 className="text-[#FFD700] text-4xl md:text-6xl font-serif mb-2">Singa Ambara</h2>
          <p className="text-white tracking-[0.3em] uppercase text-sm md:text-base font-light">Suites</p>
        </div>

        <div className="bg-[#1A2225] p-8 md:p-12 rounded-xl text-center shadow-inner border border-white/5 max-w-5xl mx-auto">
          <p className="text-gray-300 text-base md:text-lg leading-relaxed font-light">
            Singa Ambara Suites menghadirkan akomodasi modern tepat di pusat sejarah Singaraja. 
            Nikmati akses mudah ke berbagai destinasi wisata kota dengan fasilitas kamar yang luas 
            dan pelayanan terbaik. Pilihan cerdas untuk kenyamanan maksimal di Bali Utara.
          </p>
        </div>
