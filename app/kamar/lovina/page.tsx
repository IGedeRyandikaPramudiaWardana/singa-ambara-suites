...
export default function LovinaRoomDetail() {
  return (
    <main className="min-h-screen bg-[#0F1619] text-gray-200 pb-20">
      ...
      <div className="relative h-[60vh] w-full">
        <Image 
          ...
          alt="Lovina Room Header" fill className="object-cover" priority
        />
        ...
        <div className="lg:col-span-2 space-y-10">
          <section>
            ...
            <p className="text-gray-400 leading-relaxed text-lg font-light">
              Rasakan ketenangan yang sesungguhnya di Lovina Room. Dengan luas 32 m², kamar tipe Deluxe ini 
              menawarkan ruang gerak yang lebih lega dibandingkan tipe Superior. Keunggulan utamanya adalah 
              <strong> Balkon Pribadi (Private Balcony)</strong> yang menghadap ke taman asri, tempat sempurna untuk 
              menikmati kopi pagi atau bersantai di sore hari.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                ...
                <span className="font-medium text-gray-300">Private Balcony</span>
              </div>
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                <span className="text-[#D4AF37] text-2xl">🛏️</span>
                <span className="font-medium text-gray-300">King Size Bed</span>
              </div>
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                <span className="text-[#D4AF37] text-2xl">📺</span>
                <span className="font-medium text-gray-300">Smart TV 50"</span>
              </div>
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                <span className="text-[#D4AF37] text-2xl">💻</span>
                <span className="font-medium text-gray-300">Working Desk</span>
              </div>
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                <span className="text-[#D4AF37] text-2xl">🚿</span>
                <span className="font-medium text-gray-300">Rain Shower & Amenities</span>
              </div>
              <div className="flex items-center gap-4 bg-[#1A2225] p-4 rounded-lg border border-white/5">
                <span className="text-[#D4AF37] text-2xl">🛋️</span>
                <span className="font-medium text-gray-300">Seating Area</span>
              </div>
            </div>
          </section>
        </div>
          ...
          <div className="bg-[#1A2225] p-8 rounded-xl border border-[#D4AF37]/20 sticky top-24 shadow-2xl">
            <div className="text-center mb-6 border-b border-gray-700 pb-6">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-[#D4AF37] text-4xl font-bold font-serif">Rp 650.000</span>
